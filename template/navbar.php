...
<div class="navbar navbar-default navbar-static-top">
  <div class="container inaCor-container">
    ...
    <div class="navbar-collapse collapse">
        ...
        <li id="home" class="dropdown menu-large <?php echo $active['1'] == ''?'active':''; ?>">
        ...
        <li id="aboutInaCor" class="dropdown menu-large <?php echo $active['1'] == 'aboutInaCor'?'active':''; ?>">
        ...
        <li id="destinations" class="dropdown menu-large <?php echo $active['1'] == 'destinations'?'active':''; ?>">
			<a href="<?php echo $base_url; ?>destinations" class="dropdown-toggle" data-toggle="dropdown">Destinations</a>				
			<ul class="dropdown-menu inaCor-dropdown row">
                <li class="inaCor-container">
                    <a href="<?php echo $base_url; ?>destinations/view.php?kategori=1">Recomended</a>
                    <a href="<?php echo $base_url; ?>destinations/view.php?kategori=2">Spectacular Indonesia Spot</a>
                    <a href="<?php echo $base_url; ?>destinations/view.php?kategori=3">Region</a>
                    <a href="<?php echo $base_url; ?>destinations/view.php?kategori=4">Cities</a>
				</li>
			</ul>
		</li>
        <li id="attraction" class="dropdown menu-large <?php echo $active['1'] == 'attraction'?'active':''; ?>">
        ...
        <li id="cultureArt" class="dropdown menu-large <?php echo $active['1'] == 'cultureArt'?'active':''; ?>">
			<a href="<?php echo $base_url; ?>cultureArt" class="dropdown-toggle" data-toggle="dropdown">Culture/Art Life</a>				
			<ul class="dropdown-menu inaCor-dropdown row">
                <li class="inaCor-container">
                    <a href="<?php echo $base_url; ?>cultureArt/view.php?kategori=1">Culture &amp; Life</a>
                    <a href="<?php echo $base_url; ?>cultureArt/view.php?kategori=1">Art</a>
                    <a href="<?php echo $base_url; ?>cultureArt/view.php?kategori=1">Craft</a>
                    <a href="<?php echo $base_url; ?>cultureArt/view.php?kategori=1">Music/Instrument</a>
				</li>
			</ul>
		</li>
        <li id="food" class="dropdown menu-large <?php echo $active['1'] == 'food'?'active':''; ?>">
        ...
        <li id="shopping" class="dropdown menu-large <?php echo $active['1'] == 'shopping'?'active':''; ?>">
