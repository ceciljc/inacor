    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="inaCor-contentPage text-justify">
                <h3>Fresh Markets in Indonesia</h3>
                <div id="carousel_shopping" class="carousel slide" data-ride="carousel" style="margin-bottom: 25px;">
                  ...
                  <a class="left carousel-control" href="#carousel_shopping" data-slide="prev">‹</a>
                  <a class="right carousel-control" href="#carousel_shopping" data-slide="next">›</a>
                </div><!-- /.carousel -->
            </div>
