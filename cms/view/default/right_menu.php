                    ...
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                             ...
                             <ul class="nav nav-second-level">
                                  <li><a href="<?=$url_rewrite?>content/inbound/1"><i class="fa fa-institution  fa-fw"></i> Inbound</a></li>
                                  <li><a href="<?=$url_rewrite?>content/about/2"><i class="fa fa-file fa-fw"></i> Extend Visa Form</a></li>
                                  <li><a href="<?=$url_rewrite?>content/about/3"><i class="fa fa-globe fa-fw"></i> Outbound</a></li>
                             </ul>
                        </li>
                        <li>
                             <a href="<?=$url_rewrite?>content/kln/1"><i class="fa fa-group fa-fw"></i> Joint Activities</a>
